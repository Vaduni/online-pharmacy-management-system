...
export const selectAllMedicines = createSelector(selectMedicineState, selectAll);

export const selectSearchQuery = createSelector(selectMedicineState, (state) => state.searchQuery);
...
export const selectLoading = createSelector(selectMedicineState, (state) => state.loading);

export const selectError = createSelector(selectMedicineState, (state) => state.error);
    ...
    return medicines.filter((medicine) => {
      ...
      if (segment && segment !== '') {
        const matchesSegment =
          medicine.category.toLowerCase() === 'vitamins & wellness' ||
...
export const selectUniqueCategories = createSelector(selectAllMedicines, (medicines) => {
